...
Los métodos de aprendizaje automático se han vuelto cada vez mas populares en los últimos años, tanto en la diversidad como en la importancia de sus aplicaciones~\todocite{survey}{1}.
El aprendizaje automático es utilizado en una variedad de aplicaciones críticas de toma de decisiones.
Una de las mayores preocupaciones de esta situación es el hecho de que estos algoritmos pudieran estar tomando decisiones de forma sesgada y por tanto afectando a determinados grupos de individuos, lo cual se mostró era lo que estaba sucediendo~\todocite{survey}{2}.
