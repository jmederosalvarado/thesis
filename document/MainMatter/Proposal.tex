...
La búsqueda comienza con una estrategia de muestreo aleatorio, pero según evalúa mas flujos, modifica el modelo de muestreo probabilista para que flujos similares a los mejores encontrados hasta el momento, sean generados con mayor frecuencia.
